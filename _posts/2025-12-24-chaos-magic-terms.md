...
These four terms appear constantly and generate the most questions.
...
You might not realize you reached gnosis until later.
...
Think of them as a spectrum from simple to complex:
...
Learn [servitor creation techniques](#servitor-article).
...
Holding beliefs lightly enough to shift between them while believing intensely enough for them to work. Think of it like method acting for your entire worldview.

Peter Carroll suggested rolling dice to randomly select which paradigm to work in, then committing to it for a set period. This removes the temptation to cherry-pick based on comfort rather than effectiveness.
...
Explore the [philosophy behind belief-as-tool](/chaos-magic-belief-as-tool) and learn [practical paradigm shifting techniques](#paradigm-article).
...
The term comes from Latin "sigillum" meaning "seal." Austin Osman Spare developed the modern method.
...
|------|----------------|------------------|
| **Charging** | Infusing the sigil with energy via gnosis | Often conflated with firing |
| **Firing** | The moment of release/activation | Used interchangeably with charging |
| **Activating** | Vague term different authors use differently | Sometimes means the whole process |

Use "charging" for the energy work and "firing" for the release moment. Avoid "activating" since it's ambiguous.
...
Think of it like planting a seed. You plant it, water it, then leave it alone. Digging it up every day to check if it's growing kills the plant.

**"Lust for results":**

This phrase appears in every "why didn't my sigil work?" discussion.
...
These concepts form chaos magic's philosophical foundation. Brief definitions for quick reference; [explore them in depth in this article](/chaos-magic-belief-as-tool).

### Chaos

In chaos magic, "chaos" refers to infinite possibility. The underlying reality beyond perception. Similar to concepts like Brahman in Hinduism or Tao in Taoism.
...
Often interpreted as nihilistic "nothing matters" worldview, which misses the point.
...
The ongoing debate: How do you distinguish magical results from coincidence or placebo effect? The community discusses this constantly without consensus.

## Practice Mechanics

Terms you'll encounter while actually doing the work.

### Charging

In the context of sigils: Infusing the symbol with energy during gnosis.
...
The debate: How necessary is banishing? Some practitioners consider it essential, others treat it as optional. You'll develop your own practice.
...
In chaos magic, both are tools for different purposes. Neither is inherently superior.

**Related term - Godform:** A deity or archetype you invoke and embody as part of paradigm shifting. You take on that god's attributes, perspective, and power for the duration.

## The Underdocumented Jargon

These terms appear constantly in chaos magic discussions, but experienced practitioners use them without defining them.
...
**The Pact:** Shorthand for the IOT itself.
...
You'll see these referenced in forums, especially in older discussions.

**Ouranian Barbaric:** A ritual language the IOT developed, constructed from various linguistic sources. Meant to bypass semantic meaning and work directly with sound and intention.

Why this matters: IOT terminology appears throughout chaos magic literature even in texts unrelated to the organization.
...
- **Liber MMM:** Basic exercises for developing gnosis
- **Liber LUX:** "Light" practices
- **Liber NOX:** "Dark" practices
- **Liber AOM:** Advanced topics
...
**Pop magic:** Morrison's term for an accessible approach using pop culture elements rather than traditional occult imagery. Why use ancient Egyptian deities when you can work with superheroes or corporate logos?

### From Internet/Meme Magic Culture

These terms evolved in online communities before connecting to broader chaos magic practice.

**Kek:** Egyptian frog deity appropriated as a chaos magic symbol in certain online communities, particularly 4chan. The association happened through coincidences involving World of Warcraft (where "kek" is how Horde players see Alliance players' "lol") and Pepe the Frog memes. This got weird when alt-right communities adopted Pepe, creating uncomfortable associations. Many chaos magicians now avoid Kek symbolism.

**Hyperstition:** Ideas or fictions that make themselves real through collective belief and circulation. Related to egregores but emphasizes the feedback loop: the idea spreads, people act as if it's real, their actions make it functionally real, which makes it spread more.

**Gets/Dubs:** Internet culture (particularly 4chan) practice of treating post number synchronicities as magical confirmation. If your post number ends in repeating digits, it's seen as significant. Some practitioners use this as divination.

### Common Abbreviations

- **CM/CMK:** Chaos Magic/Magick
- **AOS:** Austin Osman Spare
- **TOPY:** Thee Temple ov Psychick Youth (performance art/magic collective)
- **ZKC:** Zos Kia Cultus (Austin Osman Spare's magical system)
- **LHP/RHP:** Left-Hand Path / Right-Hand Path
- **UPG:** Unverified Personal Gnosis (personal spiritual experience, not from tradition)
- **GPR:** Gnostic Pentagram Ritual

## Borrowed Terms Worth Knowing

Chaos magic remixes concepts from various traditions. These terms appear frequently enough to warrant inclusion.

### The Kia

From Austin Osman Spare's magical system. Your essential self or consciousness beneath identity and ego.

How it's used: Accessing the Kia allows you to reshape beliefs and reality at a fundamental level. You're working with the part of yourself that exists before personality, conditioning, or learned beliefs.

Do you need this concept? No. It's one model among many. You'll encounter it in discussions of Spare's work and in some chaos magic theory, but you can practice effectively without it.
...
Why some chaos magicians use it: Provides a framework for understanding reality tunnels (the limited slice of reality your current consciousness perceives) and paradigm shifting.

Do you need it? Completely optional. One of many available models for conceptualizing consciousness and belief.
...
Usage note: Mixed feelings in the community. Some embrace it, others find it unnecessary or cringey. Just say "chaos magician" or "practitioner" if "chaote" doesn't feel right.

## The "Magic" vs. "Magick" Question
...
The spelling doesn't affect the practice. Use whichever feels right.

---

These definitions will click into place as you practice. Bookmark this and return when you encounter unfamiliar terms.

Chaos magic's anti-dogmatic philosophy means definitions vary between practitioners. This is a feature, not a bug. The practice encourages you to develop your own understanding and even create your own terminology as your work evolves.
