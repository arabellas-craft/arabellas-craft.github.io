...
This is the first article in a series on Celtic Reconstructionism. Later articles cover the theology (the gods are specific individuals, not archetypes), the calendar, the primary sources, and how CR intersects with folk practices. For now, the foundation: what CR is, how it differs from Wicca and neo-paganism broadly, and where to start if you want to practice.
...
The differences between CR and Wicca run deeper than aesthetics. They have different cosmologies, theologies, and methodologies.
...
The Maiden/Mother/Crone framework, frequently applied to Celtic goddesses, is also not Celtic. The *CR FAQ* traces it to Robert Graves's 1948 book *The White Goddess* which Graves himself described as "a work of poetic imagination." Celtic goddesses are categorized by function, not age or reproductive status. Some are triple (Brigid and The Morrígan being the most common examples), but they are not young-mature-old progressions.

**Cosmology.** Where Wicca uses the four classical elements and four cardinal directions from Western ceremonial magic, CR works with a three-part cosmology: Land, Sea, and Sky. In Irish, *talam* (land), *muir* (sea), *nem* (sky). Ancient Irish oaths were sworn by these three realms. Erynn Rowan Laurie, one of CR's founding voices, describes the triple spiral as the symbol of this structure: "Oaths were sworn by land, sea and sky. All things lived within the circle." (*[A Circle of Stones](https://bookshop.org/a/84772/9781536558241)*, 2012)
...
I engage seriously with CR scholarship. It's foundational for how I approach Irish folk magic practice. But I don't practice CR as a religion, because my honest assessment of what survived is that it's not enough to reconstruct a complete pre-Christian practice.
...
<!-- [The next article in this series]() covers the history of how CR came together and became a movement. The practitioners, the mailing lists, the journals, and the organizations they built (much of which is sadly now defunct). The resources they left behind are still the foundation of the practice. -->