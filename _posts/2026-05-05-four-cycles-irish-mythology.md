...
img-text:
permalink: /irish-mythology-four-cycles
---

{% assign mythological_reveal_date = "2026-05-12" | date: "%s" %}
{% assign ulster_reveal_date = "2026-05-19" | date: "%s" %}
{% assign fenian_reveal_date = "2026-05-26" | date: "%s" %}
...
The story cycles roughly correspond to different ages of Irish mythological time as imagined by the medieval compilers. The framing text is the *[Lebor Gabála Érenn]((https://archive.org/details/LeborGablarennTheBookOfTheTakingOfIreland-Volume21939))* (Book of Invasions), a medieval pseudo-history that organized everything into successive waves of settlers:
