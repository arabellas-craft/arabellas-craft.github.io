...
You don't need to buy anything to start. The guides to [bibliomancy](/bibliomancy-book-divination), [tea leaf symbols](/common-tea-leaf-symbols-and-their-meanings), and [divination with household objects](/divination-without-buying-anything) cover methods you can try tonight with what's already in your home. The [fortune-telling games of an Irish Hallow Eve](/samhain-divination-games) worked the same way, with three saucers, nuts on the hearth, and an apple peeled in one strip and thrown over the shoulder. And when a question really is yes or no, tarot is the wrong tool for it: the guide to [better methods for binary questions](/yes-or-no-tarot) covers geomancy, pendulums, and bone throwing, and points you to the right question to ask when the binary isn't what you need.
